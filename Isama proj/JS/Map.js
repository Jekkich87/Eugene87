...
function initMap()
{
    ...
    var options = {
        zoom: 5,
        center: { lat: 24.683225, lng: 46.689923 }
    }
    ...
    var InfoWindow1 = new google.maps.InfoWindow({ content: '<p>Isama, Head office: Riyadh City, Olaya St.,Al-Rossais Commercial Center</p>' });
    var InfoWindow2 = new google.maps.InfoWindow({ content: '<p>Isama, Alexandria: Smouha Barons, Albert Al Awal St. building 6 App# 101, Alexandria, Egypt.</p>' });
    var InfoWindow3 = new google.maps.InfoWindow({ content: '<p>Isama, Kuwait: Kuwait, Kuwait City, Qubila Alshuhada St., Alsedah Tower</p>' });
